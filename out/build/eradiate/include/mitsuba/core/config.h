...
#define MI_EXTERN_STRUCT(Name)                                                  \
    ...
    MI_EXTERN_LIB template struct MI_EXPORT_LIB Name<dr::DiffArray<JitBackend::LLVM, float>, MuellerMatrix<Spectrum<dr::DiffArray<JitBackend::LLVM, float>, 4>>>; \
...
#define MI_EXTERN_CLASS(Name)                                                   \
    ...
    MI_EXTERN_LIB template class MI_EXPORT_LIB Name<dr::DiffArray<JitBackend::LLVM, float>, MuellerMatrix<Spectrum<dr::DiffArray<JitBackend::LLVM, float>, 4>>>; \
...
#define MI_INSTANTIATE_STRUCT(Name)                                             \
    ...
    template struct MI_EXPORT Name<dr::DiffArray<JitBackend::LLVM, float>, MuellerMatrix<Spectrum<dr::DiffArray<JitBackend::LLVM, float>, 4>>>; \
...
#define MI_INSTANTIATE_CLASS(Name)                                              \
    ...
    template class MI_EXPORT Name<dr::DiffArray<JitBackend::LLVM, float>, MuellerMatrix<Spectrum<dr::DiffArray<JitBackend::LLVM, float>, 4>>>; \
...
#define MI_INVOKE_VARIANT(variant, func, ...)                                   \
    [&]() {                                                                     \
        if (variant == "scalar_mono")                                           \
            ...
            Throw("Unsupported variant: \"%s\". Must be one of scalar_mono, scalar_mono_double, scalar_mono_polarized, scalar_mono_polarized_double, scalar_rgb, scalar_spectral, llvm_ad_rgb, llvm_ad_spectral_polarized!", variant); \
    }()                                                                         \
...
template <typename Float_, typename Spectrum_> constexpr const char *get_variant() {
    if constexpr (std::is_same_v<Float_, float> &&
        ...
        return "llvm_ad_rgb";
                       ...
                       std::is_same_v<Spectrum_, MuellerMatrix<Spectrum<dr::DiffArray<JitBackend::LLVM, float>, 4>>>)
        return "llvm_ad_spectral_polarized";
    else
        return "";
}
