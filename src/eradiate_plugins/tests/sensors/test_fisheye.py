...
# Calibration sheet values, normalized (pixels at 6000 x 4000)
...
def test_construct(variant_scalar_rgb):
    ...
    for kwargs in [
        ...
        poly_kwargs(mi.TensorXf([0.7, -0.06])),  # Coefficients are given as text
    ]:
...
def test_polynomial_projection(variant_scalar_rgb):
    ...
    # The calibration is expressed in normalized film coordinates, so an
