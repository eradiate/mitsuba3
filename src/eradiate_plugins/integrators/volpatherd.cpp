...
Eradiate volumetric path tracer (:monosp:`volpatherd`)
------------------------------------------------------
...
class VolumetricPathEradiateIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
...
public:
    ...
    VolumetricPathEradiateIntegrator(const Properties &props) : Base(props) {
    }
    ...
    std::string to_string() const override {
        return tfm::format("VolumetricPathEradiateIntegrator[\n"
                           "  max_depth = %i,\n"
                           "  rr_depth = %i\n"
                           "]",
...
MI_IMPLEMENT_CLASS_VARIANT(VolumetricPathEradiateIntegrator, MonteCarloIntegrator);
MI_EXPORT_PLUGIN(VolumetricPathEradiateIntegrator, "Volumetric Path Tracer Eradiate integrator");
