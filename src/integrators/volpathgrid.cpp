...
.. _integrator-volpathgrid:

Volumetric path tracer with majorant supergrid (:monosp:`volpathgrid`)
----------------------------------------------------------------------
...
class VolumetricPathGridIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
...
public:
    ...
    VolumetricPathGridIntegrator(const Properties &props) : Base(props) {
    }
    ...
    std::string to_string() const override {
        return tfm::format("VolumetricPathGridIntegrator[\n"
                           "  max_depth = %i,\n"
                           "  rr_depth = %i\n"
                           "]",
...
MI_IMPLEMENT_CLASS_VARIANT(VolumetricPathGridIntegrator, MonteCarloIntegrator);
MI_EXPORT_PLUGIN(VolumetricPathGridIntegrator, "Volumetric Path Grid integrator");
